...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        Log.Debug(migracoesRealizadas
            ? "Migra��es de banco de dados realizadas."
            : "Nenhuma migra��o de banco de dados aplicadas."
        );
        ...
        {
            Log.Fatal("Ocorreu um erro fatal durante a execu��o da aplica��o: {@Excecao}", ex);
        }
    }
}
